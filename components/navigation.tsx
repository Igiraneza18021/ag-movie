...
export function Navigation() {
  ...
  if (pathname === "/" || pathname === "/login" || pathname === "/signup" || pathname === "/forgot-password" || pathname === "/verify" || pathname === "/complete-profile" || pathname === "/subscribe" || pathname === "/profile" || pathname === "/watchlist" || pathname === "/continue-watching") return null
